...
#define ERROR_REGISTER_OUT_OF_BOUNDS "ERROR: Register number %ld is out of bounds (1..1024) on line %d in file %s\n"
#define ERROR_LABEL_EXISTS "ERROR: Label \"%s\" on line %d in file %s already exists\n"
