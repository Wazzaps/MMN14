...
#define ERROR_USELESS_LABEL "WARN: Useless label '%s', no directive or operation on line %d in file %s, label ignored\n"
...
#define ERROR_DATA_OUT_OF_BOUNDS "ERROR: Value %lu is out of bounds (-512..511) on line %d in file %s\n"
...
#define ERROR_MATRIX_DIMENSION_OUT_OF_BOUNDS "ERROR: Matrix dimension is out of bounds (1..1024) on line %d in file %s\n"
